...
if not defined CERES_VS_INSTALL for /f "usebackq tokens=*" %%i in (`"%CERES_VSWHERE%" -latest -version "[17.0,18.0)" -products * -requires Microsoft.VisualStudio.Component.VC.Tools.x86.x64 -property installationPath`) do set "CERES_VS_INSTALL=%%i"
